...
```
##Drzewo decyzyjne: Budowa i ocena modelu
Drzewo decyzyjne zostało dopasowane do zbioru treningowego, a następnie ocenione na zbiorze testowym. Poniżej przedstawiono wizualizację drzewa oraz obliczenia dokładności.
```{r}
