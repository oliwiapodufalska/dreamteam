...
P-value = 0.7836 (dużo większe niż 0.05) Brak istotnej zależności między płcią a zakupem roweru. Wniosek: Płeć nie wpływa znacząco na decyzję o zakupie roweru.

## Czy stan cywilny ma wpływ na zakup roweru?

P-value = 0.0004242 (znacznie mniejsze niż 0.05) Istotna zależność – stan cywilny wpływa na zakup roweru. Wniosek: Osoby zamężne/żonate kupują rowery w inny sposób niż osoby samotne.
...
W grupie "Single" więcej osób kupiło rower (250) niż nie kupiło (211). W grupie "Married" mniej osób kupiło rower (231) niż nie kupiło (308). Test chi-kwadrat pokazał, że ta różnica jest istotna statystycznie (p = 0.00042).
