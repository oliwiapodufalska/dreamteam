...
Dzięki temu możliwe jest prawidłowe wykorzystanie tych zmiennych w późniejszych etapach analizy, takich jak wizualizacja danych czy budowanie modeli statystycznych.
...
plot(imputed_data)  # Powinno teraz działać bez błędu
...
colSums(is.na(dane2))  # Czy nadal są braki?
